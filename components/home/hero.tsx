    ...
    <div className='min-h-screen bg-gradient-to-tr from-[#0D92B1] via-[#6C89DF] to-[#B180EF]'>
        ...
        <div className="grid justify-center w-[80%] mx-auto sm:w-full items-center h-[max-content]">
          <div className="w-[fit-content] items-center text-center">
            ...
            <div className="sm:flex  sm:flex-row justify-center space-y-4 sm:space-y-0 sm:gap-x-4">
              <button className='rounded-md bg-[#EE75F0] text-[#fff] h-[auto] p-3 px-4 font-montserrat font-bold'>Connect Wallet</button>
              <button className='rounded-md bg-[#fff] text-[#6986DC] p-3 px-4 h-[auto] font-montserrat font-bold'>Learn More</button>
            </div>
          </div>
        </div>
        <Image 
          ...
          width={150}
          height={150}
          className='absolute top-[85%] sm:w-[auto] w-[5rem] sm:top-[23%] right-[1rem] sm:left-[6.3rem]'
        />
        <Image 
        ...
        <Image 
          ...
          width={190}
          height={190}
          className='absolute top-[85%] sm:w-[auto] w-[5rem] sm:top-[66%] left-[2rem] sm:left-[4.3rem]'
        />
    </div>
  )
}
